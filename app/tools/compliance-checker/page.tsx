    ...
    <main className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[0.9] tracking-tight">
                  ...
                  CHECKER
                  <br />
                  <span className="font-light italic">AI Assessment</span>
                </h1>
                
                <div className="w-24 h-0.5 bg-black"></div>
                
                <p className="text-lg md:text-xl font-light text-gray-700 leading-relaxed">
                  Verify your compliance status across multiple European regulatory frameworks with our AI-powered assessment tool.
                  Get instant insights into gaps and recommendations for improvement.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-700">Multi-framework compliance assessment</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-5 h-5 bg-black flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">AI-powered gap analysis and recommendations</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-5 h-5 bg-black flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">Real-time regulatory updates integration</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-5 h-5 bg-black flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">Detailed compliance scoring and reporting</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-5 h-5 bg-black flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">Actionable remediation roadmaps</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="border-4 border-black p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-l-4 border-black pl-4">
                    <h4 className="font-black text-sm uppercase tracking-[0.05em] mb-1">EU AI ACT</h4>
                    <p className="text-sm text-gray-600">Artificial Intelligence Act compliance</p>
                  </div>
                  <div className="border-l-4 border-black pl-4">
                  ...
                  <div className="border-l-4 border-black pl-4">
                    <h4 className="font-black text-sm uppercase tracking-[0.05em] mb-1">NIS</h4>
                    <p className="text-sm text-gray-600">Network and Information Security</p>
                  </div>
              ...
              <div className="bg-black text-white p-8">
                ...
                <p className="text-gray-300 mb-6 font-light">
                  Be the first to know when our Compliance Checker launches.
                </p>
      ...
      <section className="px-4 md:px-12 py-12 md:py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-6 uppercase tracking-[0.1em]">Compliance by the Numbers</h2>
          <div className="w-24 h-0.5 bg-black mx-auto mb-8"></div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl font-black mb-3">4+</div>
              <p className="text-sm uppercase tracking-[0.1em] font-black text-gray-600 mb-2">Frameworks</p>
              <p className="text-sm text-gray-600">Comprehensive regulatory coverage</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-black mb-3">100%</div>
              <p className="text-sm uppercase tracking-[0.1em] font-black text-gray-600 mb-2">AI Analysis</p>
              <p className="text-sm text-gray-600">Automated compliance assessment</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-black mb-3">24/7</div>
              <p className="text-sm uppercase tracking-[0.1em] font-black text-gray-600 mb-2">Updates</p>
              <p className="text-sm text-gray-600">Real-time regulatory monitoring</p>
            </div>
          </div>
        </div>
      </section>
